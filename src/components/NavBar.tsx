  ...
  return (
    <nav className="bg-gray-100">
      <div className="container mx-auto px-4 py-2">
        ...
        {/* Mobile Navigation */}
        {isOpen && (
          <div className="lg:hidden font-montserrat absolute mx-auto bg-gray-800/85 inset-x-0 space-y-5 flex flex-col items-center gap-4 mt-2 text-white text-lg font-bold z-30">
            <a href={"#OurServices"} className="block w-full text-center py-2">
              {t("global.ourServices")}
            </a>
            <a href={"#aboutUs"} className="block w-full text-center py-2">
              {t("global.aboutUs")}
            </a>
            <a href={"#contactUs"} className="block w-full text-center py-2">
              {t("global.contactUs")}
            </a>
